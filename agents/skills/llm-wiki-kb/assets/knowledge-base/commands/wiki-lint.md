...
- Skip snapshot symlink validation: `memory/llm-wiki/snapshots/` is a symlink to `memory/kb/snapshots/`. Links like `../snapshots/05-dkt-main-2026-06-27.md` are valid via this symlink and should not be flagged as broken.
