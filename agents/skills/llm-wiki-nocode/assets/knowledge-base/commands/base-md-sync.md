...
usage: /base-md-sync [memory/bookmarks/md/*.md | memory/bookmarks/md/]
trigger: user_args
---
...
1. Refresh or replace the document table of contents in each base Markdown file under `memory/bookmarks/md/`.
...
- Only curated base Markdown documents under `memory/bookmarks/md/` should be synced.
